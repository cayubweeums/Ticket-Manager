...
class ClosedTicketDetailsPage extends StatefulWidget {
  final Ticket ticket;
  final userName;
  ClosedTicketDetailsPage(this.ticket, this.userName);



  @override
  _ClosedTicketDetailsPageState createState() => _ClosedTicketDetailsPageState();
}

class _ClosedTicketDetailsPageState extends State<ClosedTicketDetailsPage> {
  bool isAdmin = false;
  bool isOpen = true;
  ...
  void changeState(Ticket ticket){
    ...
    if(isAdmin){
      if(ticket.state == "closed"){
        this.setState(() {
          changeTicketState2(ticket, "open");
        });
      }else{
      }
    }
